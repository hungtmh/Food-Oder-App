 ...
 * Authorization + apikey headers are added automatically by RetrofitClient
 * interceptor.
 * For POST operations needing "Prefer: return=representation", pass it
 * explicitly.
 */
public interface SupabaseDbService {
        ...
        @Headers("Prefer: return=representation")
        @POST("categories")
        Call<List<Category>> createCategory(@Body Map<String, Object> category);
        ...
        @GET("reviews")
        Call<List<Review>> getReviewsWithPagination(
                        @Query("food_id") String foodIdFilter,
                        @Query("select") String select,
                        @Query("order") String order,
        ...
        Call<List<com.example.food_order_app.model.UserVoucherUsage>> getUserVoucherUsage(
                        @Query("user_id") String userIdFilter,
        ...
        @Headers("Prefer: return=representation")
        @POST("vouchers")
        Call<List<com.example.food_order_app.model.Voucher>> createVoucher(@Body Map<String, Object> voucher);
